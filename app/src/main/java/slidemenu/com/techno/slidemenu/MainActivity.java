...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            leftMenuMainArrayList.add(new LeftMenuMain(getString(R.string.str_menu) + i, R.mipmap.ic_launcher));
        }
                ...
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        try {
                            ...
                            Toast.makeText(MainActivity.this, leftMenuMain.strMenuTitle, Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    void changeFragment(Fragment fragment) {
        try {
            ...
            if (!fragmentPopped && manager.findFragmentByTag(fragmentTag) == null) {
                ...
                fragmentTransaction.replace(R.id.fwContainer, fragment, fragmentTag);
